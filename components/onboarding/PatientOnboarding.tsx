...
export default function PatientOnboarding() {
  ...
  const isContinueDisabled = step === 0 && (!data.emergencyContact || !data.emergencyPhone || !data.consentAgreed)
          ...
          <div className="relative w-full bg-white rounded-[48px] p-10 md:p-16 flex flex-col items-center shadow-2xl shadow-teal-900/10 min-h-[480px]">
            ...
            <div className="mt-12 flex flex-col items-center gap-6 z-10">
              <div className="flex items-center gap-4">
                {step === 0 && (
                  <button onClick={() => setStep(6)} className="px-10 py-3.5 rounded-2xl bg-[#f0f7f8]/80 hover:bg-[#e0f2f3] text-[#666] font-bold text-sm transition-all">
                    Skip
                  </button>
                )}
                {step > 0 && step < 6 && (
