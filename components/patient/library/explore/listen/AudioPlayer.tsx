...
/**
 * Editorial listen controls — progress + transport row.
 */
export default function AudioPlayer({
    ...
    return (
        ...
        >
            ...
            focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-brand)] focus-visible:ring-offset-2 ${isRepeating
                            ? "bg-[#FFF0E6] text-[#E8722A]"
                            : "text-[#5A5A5A] hover:bg-black/[0.04] hover:text-[#1A1A1A]"
                        }`}
                >
                    <Repeat className="h-4.5 w-4.5" strokeWidth={isRepeating ? 2.2 : 1.75} aria-hidden />
                </button>
            ...
            focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-brand)] focus-visible:ring-offset-2"
                >
                    <RotateCcw className="h-4.5 w-4.5" strokeWidth={1.75} aria-hidden />
                </button>
            ...
            focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-brand)] focus-visible:ring-offset-2"
                >
                    <RotateCw className="h-4.5 w-4.5" strokeWidth={1.75} aria-hidden />
                </button>
