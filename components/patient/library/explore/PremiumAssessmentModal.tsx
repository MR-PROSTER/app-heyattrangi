...
interface PremiumAssessmentModalProps {
  isOpen: boolean
  onClose: () => void
}

export default function PremiumAssessmentModal({
  isOpen,
  onClose,
}: PremiumAssessmentModalProps) {
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
          ...
          <motion.div
            role="dialog"
            aria-modal="true"
            aria-labelledby="premium-assessment-title"
          ...
          >
            <div className="space-y-4 text-left">
              ...
              <div className="space-y-3 font-sans font-medium text-slate-600 text-sm sm:text-base leading-relaxed">
                <p>
                  You&apos;ve reached this week&apos;s free assessment limit. Premium gives you continued access to assessments whenever you want to learn more.
                </p>
              </div>
              ...
              {/* Disclaimer */}
              <p className="text-[11px] font-medium text-slate-400 leading-normal pt-2 border-t border-slate-200/40">
                Assessments are for self-reflection and screening, not diagnosis.
              </p>
            </div>
