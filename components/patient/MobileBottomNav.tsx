...
export default function MobileBottomNav() {
  ...
  const isJournal = pathname.startsWith("/patient/journal")

  return (
    <div className="md:hidden fixed bottom-6 left-1/2 -translate-x-1/2 z-40 w-[290px] h-16 bg-white/95 backdrop-blur-md rounded-full shadow-[0_12px_36px_rgba(0,0,0,0.12)] border border-slate-100 flex items-center justify-around px-4">
      {/* Home Button */}
      <Link
      ...
      <Link
        ...
        aria-label="Go to journal analytics"
      >
        <svg
          viewBox="0 0 24 24"
          fill="none"
