...
export default function PremiumVoiceModal({
  isOpen,
  onClose,
}: PremiumVoiceModalProps) {
          ...
          >
            <div className="space-y-4 text-left">
              ...
              <div className="space-y-3 font-sans font-medium text-slate-600 text-sm sm:text-base leading-relaxed">
                <p>
                  You've used today's free voice messages. Premium gives you more space for natural, hands-free conversations with Hey Attrangi.
                </p>
              </div>
