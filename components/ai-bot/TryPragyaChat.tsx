...
// EXPRESSION_FILE_MAP removed, using centralized getBotAvatar helper.
        ...
        <div className="flex-1 flex flex-col md:flex-row w-full max-w-[1600px] mx-auto overflow-hidden relative h-full z-10">
            ...
            <div className="absolute top-4 right-4 z-30 flex items-center gap-2">
              ...
              {false && (
                <button
                  ...
                  title="End & Summarize"
                  className={`p-2 rounded-full transition-colors border shadow-sm backdrop-blur-md ${
                    summarizing || !hasStarted || messages.length === 0
          ...
          >
              ...
              <div className="absolute inset-0 z-50 backdrop-blur-md bg-white/30 flex items-center justify-center p-6 animate-in fade-in duration-500">
                <div className="bg-white/90 backdrop-blur-xl p-10 rounded-[32px] shadow-[0_20px_60px_rgba(0,0,0,0.1)] border border-white/50 text-center max-w-md w-full scale-in-center">
                  ...
                  <p className="text-gray-500 mb-8 font-medium">
                    You've used all {limitData.maxChats} chats for your current
                    plan today. Upgrade to continue chatting!
                  </p>
            ...
            <div className="w-full max-w-4xl mx-auto flex flex-col h-full bg-transparent overflow-hidden relative">
              ...
              {/* Chat Messages */}
              <div
                className={`overflow-y-auto p-6 md:p-8 space-y-6 no-scrollbar bg-transparent transition-all duration-700 ease-in-out ${
                  !hasStarted
                            ...
                            <div className="flex flex-col gap-1.5">
                              <div className="flex items-center gap-2">
                                ...
                                <span className={`px-2 py-0.5 text-[10px] font-bold uppercase rounded-md ${
                                  (msg.action as any).severity === "severe" ? "bg-red-100 text-red-700" :
                ...
                <div className="max-w-4xl mx-auto relative">
                  ...
                  >
                    ...
                    <button
                      ...
                      className={`p-2.5 rounded-[14px] h-10 w-10 shrink-0 mb-1 transition-all duration-300 flex items-center justify-center ${
