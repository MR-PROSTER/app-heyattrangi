  ...
  const handleEmailContinue = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!orgRes.ok || !orgData.success) {
        setError(orgData.message || "No partner institute found for this email domain.")
        setIsLoading(false)
        return
      }
        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="mb-8 text-left">
            ...
            <p className="text-gray-500 text-sm font-normal leading-relaxed">
              {step === "EMAIL" && "Enter your institute email address to create your account."}
            ...
            <div className="space-y-6">
                ...
                <form onSubmit={handleOtpVerify} className="space-y-4">
                  <div className="space-y-2">
                    <p className="text-sm text-gray-500 font-medium">
                      ...
                      {orgName ? (
                        <>
                          {" "}for <span className="font-semibold text-gray-700">{orgName}</span>
                        </>
                      ) : null}
                      .
                    </p>
              ...
              <div className="text-center mt-2">
                <p className="text-sm text-gray-500">
                  ...
                  <Link href="/auth/institution/signin" className="font-semibold text-[#e26843] hover:underline">
                    Log in
                  </Link>
                </p>
              </div>
